  ...
  <div class="footer">
    <div class="footer-content">
      ...
      <div class="footer-section contact-form">
        ...
        <li><a href="#" style="text-decoration: none; color: white;">Merchandise</a></li>
        ...
        <li><a href="#" style="text-decoration: none; color: white;">Music+Vinyl</a></li>
        <li><a href="#" style="text-decoration: none; color: white;">Tour</a></li>
      ...
      <div class="footer-bottom">
        &copy; YellowBoyzProductions.com | Designed by Kyle Young
      </div>
    </div>
  </div>
</body>
