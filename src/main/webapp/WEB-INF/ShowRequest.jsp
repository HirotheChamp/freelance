...
<div class="card" style="width: 25rem;">
			<div class="card-body">
				...
				<p class="card-text">Hello! My name is Jane Doe and I am here to help you walk your dogs after
				a long day! I've been walking dogs since a young age and have become to enjoy it as a side hobby.
				if you are willing enough, I would love to take your dog for a walk.</p>
...
<div class="col">
		<div class="card" style="width: 25rem;">
			<div class="card-body">
				<h5 class="card-title">Walking Your Dog</h5>

				<p class="card-text">*will have description of request* will
					walk your dog for 3 days</p>
				<h6 class="card-subtitle mb-2 text-bold">5 day delivery</h6>


			</div>
			<button type="button" class="btn btn-success btn-block mb-3">Continue
